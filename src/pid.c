...
PidVars driveCurve_pid = {.doneTime = LONG_MAX, .DONE_ZONE = 4, .maxIntegral = 40, .iActiveZone = DIA, .target = 0.0, .sensVal = 0.0, .prevErr = 0.0, .errTot = 0.0, .kp = 9, .ki = 0.0075, .kd = 200.0, .prevTime = 0, .unwind = 0};
#define TIA 40
#define TDZ 10
