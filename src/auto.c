        ...
        while (allowRepeat) {
            ...
            if (i == j++) {  // deploy
                ...
                if (!driveDone) {
                    ...
                    if (curDL - prevDL > 0 || curDR - prevDR > 0) {
                        setDL(-5);
                        setDR(-5);
                    } else {
                        setDL(0);
                ...
                if (y == g++) {
                    ...
                    printf("drv%d c3 ", (int)d0);
                    if (pidDriveShort(2, DRIVE_T)) yDone = true;
                }
                if (uDone && yDone) {
                    t0 = LONG_MAX;
                    i++;
                ...
                if (zone == 20) {
                    if (y == g++) {
                        ...
                        printf("trn1 ");
                        if (pidTurn(turnFac * (loaderSide ? 86 /*106*/ : 133), DRIVE_T)) {
                            resetDriveEnc();
                            breakTime = 5000;
                            y++;
                        }
