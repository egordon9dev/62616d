 ...
 * those who do not, a header file allows multiple files to reference functions
 * in other files without necessarily having to see the code (and therefore
 * causing a multiple definition). To make a function in "opcontrol.c",
 * "auto.c", "main.c", or any other C file visible to the core implementation
